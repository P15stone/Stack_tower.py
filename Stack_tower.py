...
firstSound = pygame.mixer.Sound("music/Stack_tower_bgm.ogg")
firstSound.play()
...
class Stack:
    ...
    def pushToStack(self):
        ...
        secondSound = pygame.mixer.Sound("music/click_sound.ogg")
        secondSound.play()
...
def gameOver():
    ...
    gamoverSound = pygame.mixer.Sound("music/gamover_sound.ogg")
    gamoverSound.play()
    gamoverSound.set_volume(10)
